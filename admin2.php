	...
	<div id="page">
        ...
        <div>
			<form align="center" action="admintb/hello.php" method="post" >
				...
				<b>Students Enrolled for physics</b>&nbsp;<input type="submit" id="b3" value="go"> <br><br>
				<b>Students Enrolled for chemistry</b>&nbsp;<input type="submit" id="b4" value="go"> <br><br>
                <b>Total Students Enrolled</b>&nbsp;<input type="submit" id="b5" value="go"> <br><br>
			</form>	
		</div>
