                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="name" value="<?php echo $_SESSION['name'] ?>" readonly>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="email" name="email" value="<?php echo $_SESSION['user'] ?>" readonly>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
